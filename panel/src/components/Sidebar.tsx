...
const MODULE_NAV: { module: string; section: string; href: string; label: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    href: '/doctors',
    label: 'Doctores',
    icon: <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="8" cy="5" r="3"/><path d="M2 14c0-3.3 2.7-5 6-5s6 1.7 6 5"/><path d="M11 10v3M9.5 11.5h3"/></svg>,
  },
  {
    module: 'medical',
    section: 'MedAgent',
...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    // Reload when add-ons page saves modules
    function onStorage(e: StorageEvent) {
      if (e.key === 'modules_updated') loadBusiness()
    }
