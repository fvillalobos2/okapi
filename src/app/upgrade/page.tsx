...
const PLANS = [
  {
    ...
    label: 'Starter',
    price: 29,
    features: ['1 local', 'Hasta 200 opiniones/mes', 'Google + 1 plataforma', 'Email al manager', 'QR descargable'],
    popular: false,
  },
  {
    id: 'pro' as Plan,
    label: 'Pro',
    price: 59,
    features: ['1 local', 'Opiniones ilimitadas', '6 plataformas', 'WhatsApp + Email', 'Dashboard completo', 'Categorías por negocio'],
    popular: true,
  },
  {
    id: 'business' as Plan,
    label: 'Business',
    price: 129,
    features: ['Hasta 5 locales', 'Opiniones ilimitadas', '6 plataformas', 'WhatsApp + Email', 'Dashboard multi-local', 'Onboarding asistido', 'Soporte prioritario'],
    popular: false,
  },
]
